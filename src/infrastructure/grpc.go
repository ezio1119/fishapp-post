...
func NewGrpcServer(middL middleware.Middleware, postController post_grpc.PostServiceServer, entryController entry_post_grpc.EntryServiceServer) *grpc.Server {
	...
	entry_post_grpc.RegisterEntryServiceServer(server, entryController)
